...
const ShowNft = ({ ncontract }) => {
  ...
  const handleSell = async (tokenId) => {
    try {
      ...
      console.log(
        "sellData--------gffdhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh"
      );
      setbuyorSaled1(true);
      setIsLoading1(false);
  ...
  console.log("kfjgkfjfjgiogjihtg", buyorSaled1);
            ...
            {isLoading ? (
              ...
              <>
                <div className="flex flex-wrap my-12 w-full justify-start gap-6">
                  {getData ? (
                    getData.map((items) => {
                      console.log("sdwdwdwdwdw", items.isListed);
