...
const Transfer = ({ ncontract, allAccounts }) => {
                      ...
                      <>
                         <div className="w-[250px] h-[350px] bg-[#0b1138] rounded overflow-hidden shadow-lg my-4 hover:opacity-70">
                          ...
                          <div className="px-6 py-2">
                            <div className="font-bold text-xl mb-2">{Dataobject.name}</div>
                            <div className="font-semibold text-base mb-2">
                              {Dataobject.price}Eth
                            </div>
                            <p className="text-sm text-gray-300">{Dataobject.description}</p>
                          </div>
                          </div>
                        </>
                        : <p>No Data</p>
